...
#define DEFAULT_IP                           "192.168.193.55"          // Enter your IP address
#define DEFAULT_DNS                          "192.168.193.1"           // Enter your DNS
#define DEFAULT_GW                           "192.168.193.1"           // Enter your Gateway
...
#define DEFAULT_ADMIN_PASS                   "#12345"
...
#define DEFAULT_SERVER      "103.190.28.12"                                  // Enter your Server IP address
...
#define DEFAULT_SPI                             1                 //0=disabled 1=enabled and for ESP32 there is option 2 =HSPI
...
#define DEFAULT_NTP_HOST                        "0.id.pool.ntp.org"                // NTP Server Hostname
...
#define DEFAULT_WEB_LOG_LEVEL                   LOG_LEVEL_DEBUG_MORE    // Web Log Level
...
#define WEBPAGE_TEMPLATE_HIDE_HELP_BUTTON 1
 ...
 */
///*
#define WEBPAGE_TEMPLATE_DEFAULT_HEADER "<header class='headermenu'><h1>CHETREE: {{title}}</h1><BR>"
#define WEBPAGE_TEMPLATE_DEFAULT_FOOTER "<footer><br><h6>Powered by <a href='chetree.githb.io' style='font-size: 15px; text-decoration: none'>Chetree R&D</a></h6></footer></body></html>"
#define WEBPAGE_TEMPLATE_AP_HEADER      "<body><header class='apheader'><h1>Welcome Chetree R&D AP</h1>"
...
// #define FEATURE_SERVO  1   // Uncomment and set to 0 to explicitly disable SERVO support
  ...
  #define USES_P108   // NPK SENSOR 3P
